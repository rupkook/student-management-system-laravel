            ...
            <header class="bg-white shadow-sm border-b">
                <div class="px-6 py-4">
                    <div class="flex items-center">
                        ...
                        <h1 class="text-3xl font-bold text-gray-800">Edit Enrollment</h1>
                    </div>
                </div>
            </header>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <form action="{{ route('enrollments.update', $enrollment->id) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" name="grade" id="grade-input" min="0" max="100" step="0.1"
                                   class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="notes" rows="4"
                                      class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('notes', $enrollment->notes ?? '') }}</textarea>
                            @error('notes')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
